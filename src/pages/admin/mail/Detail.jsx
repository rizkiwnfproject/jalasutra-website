        ...
        <main>
            ...
            <div className="w-full mx-auto p-4 bg-white rounded-lg shadow-md">
                <div className="flex justify-between items-center">
                    ...
                    <button type="button" className="px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Hapus</button>
                </div>
                        ...
                        <div className="flex flex-row items-start justify-between gap-4">
                            ...
                            <dl className="max-w-md text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                                <div className="flex flex-col pb-3">
                                    <dt className="mb-1 text-gray-500 md:text-md dark:text-gray-400">Pengaju</dt>
                                    <dd className="text-sm text-gray-700 dark:text-gray-400">yourname@flowbite.com</dd>
                                </div>
                                <div className="flex flex-col py-3">
                                    <dt className="mb-1 text-gray-500 md:text-md dark:text-gray-400">Keperluan</dt>
                                    <dd className="text-sm text-gray-700 dark:text-gray-400">Nisi quis sit anim amet. Irure ex irure adipisicing sint laboris exercitation voluptate excepteur esse reprehenderit fugiat. Tempor nulla incididunt qui aute ad sunt consectetur.</dd>
                                </div>
                                <div className="flex flex-col py-3">
                                    <dt className="mb-1 text-gray-500 md:text-md dark:text-gray-400">Alamat</dt>
                                    <dd className="text-sm text-gray-700 dark:text-gray-400">92 Miles Drive, Newark, NJ 07103, California, USA</dd>
                                </div>
                                <div className="flex flex-col pt-3">
                                    <dt className="mb-1 text-gray-500 md:text-md dark:text-gray-400">Nomor Telepon</dt>
                                    <dd className="text-sm text-gray-700 dark:text-gray-400">+62 987 654 213</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
